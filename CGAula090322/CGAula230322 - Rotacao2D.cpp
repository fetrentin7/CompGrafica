...
void rotacionar(Poligono& poligono, double angulo) {
	...
	for (int i = 0; i < poligono.vertices.size(); i++) {
		poligono.vertices[i].first = poligono.vertices[i].first - pivo.first;
		poligono.vertices[i].second = poligono.vertices[i].second - pivo.second;
		...
		double aux = poligono.vertices[i].first * matriz[0][0] + poligono.vertices[i].second * matriz[0][1];
		poligono.vertices[i].second = poligono.vertices[i].first * matriz[1][0] + poligono.vertices[i].second * matriz[1][1];
		poligono.vertices[i].first = aux;
